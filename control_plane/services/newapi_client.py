...
class NewApiClient:
    ...
    async def _request(
        ...
        if include_user_header:
            if not self._user_id:
                return {'success': False, 'message': 'Missing New-Api-User context', 'error_code': 'auth_contract_mismatch'}
    ...
    def _is_auth_contract_message(self, message: str) -> bool:
        return 'user id' in message.lower() or 'not logged in' in message.lower() or 'Missing New-Api-User' in message
